...
Command: npx gltfjsx@6.2.18 fire_animation.glb 
...
export function Fire(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('static/fire_animation.glb')
  const { actions } = useAnimations(animations, group)
  React.useEffect(() => {
    if (actions) {
      console.log(actions)
      // Play the animation. Replace 'AnimationName' with the name of your animation
...
useGLTF.preload('static/fire_animation.glb')
